    ...
    place.addEventListener('change', e => {
        ...
        if (place.value === '경상남도'){
            ...
            if (selectedArea){
                ...
                live.addEventListener('change', e => {
                    const selectedOptionText = document.querySelector('.gnarea').options[document.querySelector('.gnarea').selectedIndex].text;
        ...
        if (place.value === '대전광역시') {
            ...
            if (selectedArea) {
                ...
                live.addEventListener('change', e => {
                    ...
                    const selectedOptionText = document.querySelector('.daejeonarea').options[document.querySelector('.daejeonarea').selectedIndex].text;
                    console.log(selectedOptionText);
                    se[0] = true;
                })
         ...
         */
            ...
            if (selectedArea){
                ...
                live.addEventListener('change', e => {
                    const optionvalue = document.querySelector('.seoularea').options[document.querySelector('.seoularea').selectedIndex]
                    const selectedOptionText = document.querySelector('.seoularea').options[document.querySelector('.seoularea').selectedIndex].text;
                    console.log(selectedOptionText);
                    optionvalue.setAttribute('value', selectedOptionText);
                    se[0] = true;
        ...
        if (place.value === '충청남도'){
            ...
            if (selectedArea){
                ...
                live.addEventListener('change', e => {
                    const selectedOptionText = document.querySelector('.cnarea').options[document.querySelector('.cnarea').selectedIndex].text;
                    console.log(selectedOptionText);
                    se[0] = true;
                })
