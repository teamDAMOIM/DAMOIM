        ...
        <c:forEach var="r" items="${rList}">
            <a class="rp-one" href="/recruit/detail?rno=${r.rno}">
                ...
                <c:if test="${r.category=='FREEDOM'}">
                    <div class="category">
                        <div class="category-icon" style="background: #ffcbb5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" style="color: #ff601a;" class="bi bi-three-dots" viewBox="0 0 16 16">
            ...
            if (r.title === $inputKeyword.value) {
                ...
                if(`\${r.category}`==='FREEDOM'){
                    tag +=
                        `<div class="category-icon" style="background: #ffd3be">
                            <!-- 점3개 아이콘 -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" style="color: #ff601a;" fill="currentColor" class="bi bi-three-dots" viewBox="0 0 16 16">
                                <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3m5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3m5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3"/>
                            </svg>
                        </div>`
                }
